...
def main():
    ...
    out={'phase':'II-KN','family':'tap_pair(k,v): x^k-x^v-1 over F3','engine':'python-flint 0.9.0 nmod_poly.factor + fmpz.factor','qualification':qualification,'orders':args.orders or [],'records':records,'runtime_seconds':time.time()-t}
